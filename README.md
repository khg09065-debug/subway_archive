...
☕ **브랜드 상세 분석**: 각 브랜드별로 전철역을 중심으로 하버사인 거리를 재서 500m 안에 있는 지점을 확인

📊 **고도화된 상권 분류 모델** : 클러스터를 4개의 군집으로 돌려 어떤 성격을 가진 군집인지 확인

🚇 **전철역 상권** : 전철역을 클릭하면 월 승하차객 평균, 전철역의 커피 체인점 개수, 프리미엄 브랜드 개수, 가성비 브랜드 개수를 확인

🌓 **화면 모드** : 라이트 모드/다크 모드 선택
